...
const { createUser, getUser, login, deleteUser, updateUser, getUserInformation, getUserFromId, setAvatar,updateUserInfo } = require("../controllers/user.controllers");
...
UserRouter.post("/updateinformation",authenticate,updateUserInfo)
